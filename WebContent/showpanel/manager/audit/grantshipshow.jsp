...
<div align="center" style="margin-top: 10px">
	...
	%><table width="95%">
		<tr height="25px">
			<td><a href="manager/audit.action?type=grantship">返回</a></td>
	...
	<table width="95%">
		<tr align="center">
			<td colspan="2"><input type="button"
				onclick="window.location.href='manager/audit.action?type=grantship&action=audit&status=true'"
				value="通过"></td>
			<td colspan="2"><input type="button"
				onclick="window.location.href='manager/audit.action?type=grantship&action=audit&status=false'"
				value="不通过"></td>
		</tr>
	</table>
	<%
