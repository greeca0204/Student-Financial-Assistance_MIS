...
<div>
	<%
		GradeInfo m = (GradeInfo) session.getAttribute("show");
	%>
	<form action="manager/update.action" method="post"
		onsubmit="return checkGradeInfo(this)" style="top: 30px">
		<table align="center" width="70%">
			<tr height="30px" align="center">
				<td colspan="2">修改年级信息<input name="type" value="grade"
					type="hidden" /><input name="action" value="update" type="hidden" /><input
					name="id" value="<%=m != null ? m.getId() : 0%>" type="hidden" /></td>
			</tr>
			<tr height="30px" align="center">
				<td width="30%" align="right">年级名称</td>
				<td width="60%" align="left"><input name="name"
