...
<div align="center" style="margin-top: 10px">
	...
	<table width="95%">
		...
		%><tr align="center" height="25px">
			<td><%=i + 1%></td>
			<td><a
				href="manager/update.action?action=show&type=poorstu&stuid=<%=poorstu.getStuId()%>"><%=poorstu.getStuAccname()%></a></td>
			<td><a
				href="manager/update.action?action=show&type=poorstu&stuid=<%=poorstu.getStuId()%>"><%=poorstu.getStuName()%></a></td>
