...
<div align="center" style="margin-top: 10px">
	...
	<table width="95%">
		<tr align="center" height="25px">
			<th colspan="5">非贫困学生信息</th>
		</tr>
		<tr align="center" height="25px">
			<td colspan="2"></td>
			<td colspan="3"><form action="manager/add.action" method="post">
		...
		%><tr align="center" height="25px">
			...
			<td><a
				href="manager/add.action?type=poorstu&action=add&id=<%=i%>"><button>添加贫困资料</button></a></td>
		</tr>
		<%
			}
		%>
