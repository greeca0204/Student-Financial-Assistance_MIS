...
function deleteMajor(k)
{
    if(confirm("是否删除该专业相关的全部信息？"))
    {
        location.href="manager/delete.action?majorid="+k+"&action=delete&type=major";
    }
}
</script>
	...
	<table width="95%">
		...
		%><tr align="center" height="25px">
			...
			<td align="center"><input type="submit" value="删除"
				onclick="deleteMajor(<%=major.getId()%>)" /></td>
		</tr>
		<%
			}
		%>
